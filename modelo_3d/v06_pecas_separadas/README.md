...
A parte de cima do para-brisa segue a foto de bordo carro_14. A travessa da gaiola sobe em arco com o teto. O painel de interruptores fica colado à esquerda do retrovisor. Uma faixa quebra-sol clara, com o logo invent, cobre por dentro os 12 cm de cima do vidro, de uma borracha à outra. Na carroceria da V6, a câmera fica 14 cm mais à frente que no cockpit clássico (x = −0,25). Dali, o retrovisor ocupa cerca de 50° da vista, como na foto, e aparece mais para-brisa.
