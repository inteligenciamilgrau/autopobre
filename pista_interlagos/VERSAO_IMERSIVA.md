...
4. **Corrida:** uma volta completa contra 14 adversários com nomes e números das tabelas da Old Stock enviadas pelo usuário. Eles percorrem o traçado e reduzem nas curvas. As carrocerias compartilham a geometria refinada do Opala, com cores e identificadores próprios. O HUD mostra a posição na pista, gasolina, condição do carro e do vidro.
