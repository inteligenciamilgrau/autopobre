...
with sync_playwright() as p:
 ...
 for mobile,immersive in [(True,True),(False,False)]:
  ...
  page.click('#settingsButton');page.locator('#immersiveMode').set_checked(immersive);page.click('#settingsBack');page.click('#start')
  ...
  page.click('#resultsRecords');wait_js(page,"document.querySelector('#lapRecords').open")
  page.fill('#recordName','Piloto teste <99>');page.click('#recordForm button');wait_js(page,"document.querySelector('#recordsMessage').textContent.includes('Tempo gravado')")
