...
with sync_playwright() as p:
 ...
 for mobile,immersive in [(True,True),(False,False)]:
  ...
  page.fill('#pilotName','Piloto teste <99>');page.click('#storyStart' if immersive else '#start');wait_js(page,'window.interlagos?.ready')
  ...
  assert 'Modo Corrida' in page.inner_text('#start') and 'Modo História' in page.inner_text('#storyStart')
  page.click('#start' if immersive else '#storyStart')
