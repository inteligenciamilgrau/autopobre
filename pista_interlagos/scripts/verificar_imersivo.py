...
with sync_playwright() as p:
 ...
 try:
  ...
  page.evaluate('''()=>{for(let i=0;i<400&&fixtureMode.state.phase==='grid';i++)fixtureMode.step({throttle:0,brake:0,left:0,right:0,handbrake:0,reverse:0},1/120);}''');check('five_rivals',info()['phase']=='race' and len(info()['rivals'])==5);shot('corrida')
