...
with sync_playwright() as p:
 ...
 try:
  ...
  page.select_option('#camera','cockpit');page.click('#start');page.keyboard.down('KeyS')
  ...
  page.select_option('#camera','chase');page.evaluate('interlagos.reposition(600)');page.click('#start');page.mouse.click(700,440)
  ...
  page.select_option('#camera','hood');page.click('#start');page.mouse.click(700,440);wait_js(page,'!!document.pointerLockElement && interlagos.viewControls().pointerLocked')
  ...
  fallback.goto('http://127.0.0.1:8799/pista_interlagos/teste/',wait_until='networkidle',timeout=120000);wait_js(fallback,'window.interlagos?.ready',timeout=120000);fallback.uncheck("#immersiveMode");fallback.click('#start')
