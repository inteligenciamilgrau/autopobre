...
with sync_playwright() as p:
 ...
 try:
  ...
  page.click('#settingsButton');page.click('#tab-audio');page.locator('#effectsVolume').fill('0');wait_js(page,'interlagos.audioInfo().rms>.001');check('effects_zero_keeps_music',True)
