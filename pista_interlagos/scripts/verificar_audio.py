...
with sync_playwright() as p:
 ...
 try:
  ...
  speed(65,True);page.keyboard.press('Space');page.keyboard.down('KeyA');wait_js(page,'interlagos.audioInfo().skid>.2')
  check('skid_sound_tracks_tyre_marks',info()['skid']>.2 and page.evaluate('interlagos.skidInfo().totalSegments')>0)
  page.keyboard.press('Space');page.keyboard.up('KeyA');page.keyboard.press('KeyM');wait_js(page,'interlagos.audioInfo().rms<.00001')
