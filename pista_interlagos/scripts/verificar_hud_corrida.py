...
with sync_playwright() as p:
 ...
 try:
  ...
  page.tap('#settingsButton');page.uncheck('#immersiveMode');page.select_option('#camera','aerial');page.tap('#settingsClose');enter_track(page,tap=True)
  ...
  page.tap('#touchMenu');page.check('#immersiveMode');page.tap('#settingsClose');page.tap('#start')
  ...
  page.tap('#touchMenu');page.uncheck('#immersiveMode');page.tap('#settingsClose');page.tap('#start');wait_js(page,'!interlagos.state.paused');check('return_to_normal_uses_rear_camera',page.evaluate("interlagos.state.mode==='chase'"))
