...
for(const immersive of [false,true]){
 ...
 m.contacts=m.sync=m.wallImpact=()=>{};m.parts={reset(){}};m.laps=3;m.storyLaps=3;m.resetField();
 const c=m.car;c.vx=Math.cos(c.heading)*40;c.vy=Math.sin(c.heading)*40;c.clock=250;c.laps=3;
