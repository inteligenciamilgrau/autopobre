export function setupSettings(pause,onMainMenu){
 ...
 const close=()=>dialog.close();document.getElementById('settingsClose').onclick=close;document.getElementById('settingsBack').onclick=()=>{close();onMainMenu();};
